...
Процедура ТестДолжен_ПроверитьПередачуОбъекта() Экспорт
	...
	юТест.ПроверитьРавенство(Список.Получить(0), "Text1", "Прокси.EchoObject(... param ...).List[0]");
	юТест.ПроверитьРавенство(Список.Получить(1), "Text2", "Прокси.EchoObject(... param ...).List[1]");
